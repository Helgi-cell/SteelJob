...
private double angleDataofHalfPipe (double aa);//вычисление угла развертки угла желоба

вычисление массива 
отрезков для получения развертки колена
void Otrarray (int iter, double radius, double angleknee,double step);

вычисление массива отрезков для получения развертки угла желоба
...
void steelKnee();
// Расчет развертки угла желоба
void steelAngleofHalfPipe();
}