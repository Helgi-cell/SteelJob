...
private static void Otrarray (int iter, double radius, double angleknee, double step1){
...
private static void OtrarrayofHalfPipe (int iter, double radius, double angleknee, double step1){
    ...
    int i = 1;
        ...
        otrarr [0]=2*radius;
            ...
            ++i;
            data [i][0]= "Диаметр желоба";
            data [i][1]= "мм" ;
            data [i][2]= String.format("%.0f",2*radius);
            
            ++i;
            data [i][0]= "Угол желоба";
            data [i][1]= "град." ;
            data [i][2]= String.format("%.0f",(angleknee*360/PI));
...
private static double angleData (double aa){
    double aa1;
        aa1=aa/2*PI/180;
            return (aa1);
}

private static double angleDataofHalfPipe (double aa){
    double aa1;
        aa1=(180-aa)/2*PI/180;
            return (aa1);
}

private static double showData (double aa, double hs){
    double h1;
        h1= Math.sqrt(aa/2*aa/2+hs*hs);
            return h1;
}
private static double showData (double aa, double bb, double hs) {
    double reb;
